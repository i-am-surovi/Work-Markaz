...
const JobCard=(props:any)=>{
    return <Link to="/jobs" className="bg-white-100 p-4 w-80 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_blue] !shadow-azure-radiance-600 cursor-default">
